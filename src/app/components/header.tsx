    ...
    <div className="bg-violet-700 text-white py-2 text-sm flex items-center justify-center">
      ...
      <div className="w-full max-w-[1200px] flex items-center justify-between px-4">
        ...
        <div className="flex items-center justify-center gap-6 w-full sm:w-auto">
          {/* Email */}
          <a
            href="mailto:khassaan139@gmail.com"
            className="flex items-center gap-2 hover:text-gray-200"
          >
            <FaEnvelope />
            <span>nida@gmail.com</span>
          </a>
          {/* Phone */}
          <a
            href="tel:+44 406 265854"
            className="flex items-center gap-2 hover:text-gray-200"
          >
            <FaPhoneAlt />
            <span>(021)65567</span>
    ...
    return (
        <div className='flex flex-col md:flex-row w-full   md:w-[1170px] mt-[30px] px-4 md:px-16 items-center max-w-screen-xl mx-auto  '>
            ...
            <ul className='flex flex-col md:flex-row w-full md:w-auto justify-center md:justify-between gap-4 md:gap-[48px] text-[#000000]'>
                ...
                <Link href={"/pages"} className='font-poppins text-[16px] font-bold text-center md:text-left w-[66px] h-[24px] '>Pages</Link>
                <Link href="/product" className='font-poppins text-[16px] font-bold text-center md:text-left w-[48px] h-[24px] '>Product</Link>
                ...
                <Link href="/contact" className='font-poppins text-[16px] font-bold text-center md:text-left w-[61px] h-[24px] '>Contact</Link>
